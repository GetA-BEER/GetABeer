...
public class SeleniumStarter {
	...
	public List<CrawledInfo> createCrawledInfo() throws InterruptedException {
		...
		for (String engName : TEST_LIST) {
			...
			WebElement webElement = webDriver.findElement(By.xpath(SEARCH_BOX));
	...
	public WebElement findElementByXPath(String location) {

		waitDuration(location, webDriverWait);
		return webDriver.findElement(By.xpath(location));
	}

	public List<WebElement> findElementsByXPath(String location) {
