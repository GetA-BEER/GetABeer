      ...
      >
        <div className="select-none">
          {beerCategoryList.map((el: string, idx: number) => (
            <SwiperSlide key={idx}>
              <div className="ml-2 font-bold flex justify-center items-center h-[58px] lg:h-32 md:h-28 sm:h-24  bg-y-gold text-[8px] lg:text-lg rounded-xl hover:text-y-cream">
                {el}
              </div>
            </SwiperSlide>
          ))}
