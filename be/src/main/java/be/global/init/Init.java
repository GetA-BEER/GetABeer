...
import static be.global.init.InitConstant.BEER_DETAILS_COUNTS;
...
public class Init {
    ...
    @Bean
    @Transactional
    CommandLineRunner stubInit(BeerController beerController, BeerMapper beerMapper, BeerService beerService, BeerRepository beerRepository,
