...
public class SeleniumConstant {
    ...
    public static final String START_URL = "https://www.ratebeer.com/beer/toppling-goliath-kentucky-brunch/166019";
    public static final String SEARCH_BOX = "//*[@id=\"root\"]/div[2]/header/div[2]/div[1]/div[2]/div/div/input";
    ...
    public static List<String> NAME_LIST = new ArrayList<>(List.of("kloud", "fitz super clear", "Asahi super dry", "Tsingtao", "Heineken",
