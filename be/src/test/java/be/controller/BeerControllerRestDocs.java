...
import static be.utils.ApiDocumentUtils.getDocumentRequest;
import static be.utils.ApiDocumentUtils.getDocumentResponse;
                ...
                .andDo(document(
                        ...
                        requestFields(
                                List.of(
                                        ...
                                        fieldWithPath("beerCategories[].beerCategoryId").type(JsonFieldType.NUMBER).description("맥주 카테고리 아이디"),
                                        fieldWithPath("beerCategories[].beerCategoryType").type(JsonFieldType.STRING).description("맥주 카테고리 타입"),
                        ...
                        responseFields(
                                List.of(
                                        ...
                                        fieldWithPath(".beerDetailsBasic.thumbnail").type(JsonFieldType.STRING).description("썸네일 이미지 주소"),
                                        ...
                                        fieldWithPath(".beerDetailsCounts.totalStarCount").type(JsonFieldType.NUMBER).description("전체 별점 수"),
                                        fieldWithPath(".beerDetailsCounts.femaleStarCount").type(JsonFieldType.NUMBER).description("여성 별점 수"),
                                        fieldWithPath(".beerDetailsCounts.maleStarCount").type(JsonFieldType.NUMBER).description("남성 별점 수"),
                                        fieldWithPath(".beerDetailsCounts.commentCount").type(JsonFieldType.NUMBER).description("코멘트 수"),
                                        fieldWithPath(".beerDetailsCounts.pairingCount").type(JsonFieldType.NUMBER).description("페어링 수"),

                                        fieldWithPath(".beerDetailsStars").type(JsonFieldType.OBJECT).description("맥주 관련 별점"),
                                        fieldWithPath(".beerDetailsStars.totalAverageStars").type(JsonFieldType.NUMBER).description("맥주 총 별점 평균"),
                                        fieldWithPath(".beerDetailsStars.femaleAverageStars").type(JsonFieldType.NUMBER).description("맥주 여성 별점 평균"),
                                        fieldWithPath(".beerDetailsStars.maleAverageStars").type(JsonFieldType.NUMBER).description("맥주 남성 별점 평균"),
                ...
                .andDo(document(
                        ...
                        requestFields(
                                List.of(
                                        ...
                                        fieldWithPath("beerCategories[].beerCategoryId").type(JsonFieldType.NUMBER).description("수정된 맥주 카테고리 아이디"),
                                        fieldWithPath("beerCategories[].beerCategoryType").type(JsonFieldType.STRING).description("수정된 맥주 카테고리 타입"),
                        ...
                        responseFields(
                                List.of(
                                        ...
                                        fieldWithPath(".beerDetailsBasic.thumbnail").type(JsonFieldType.STRING).description("수정된 썸네일 이미지 주소"),
                ...
                .andDo(document(
                        ...
                        responseFields(
                                List.of(
                                        ...
                                        fieldWithPath("[].beerCategories[].beerCategoryId").type(JsonFieldType.NUMBER).description("맥주 카테고리 타입 번호"),
                                        fieldWithPath("[].beerCategories[].beerCategoryType").type(JsonFieldType.STRING).description("맥주 카테고리 타입"),
                                        fieldWithPath("[].beerTags[]").type(JsonFieldType.ARRAY).description("맥주 태그 리스트"),
